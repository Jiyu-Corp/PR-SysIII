...
export class CreateAgreementDto {
    @IsDefined({ message: "Cliente é obrigatório." })
    ...
    @IsDefined({ message: "Porcentagem de desconto é obrigatória na ausencia do desconto fixo." })
    ...
    @IsDefined({ message: "Desconto fixo é obrigatório na ausencia do desconto percentual." })
    ...
    @IsDefined({ message: "Data de expiração do convênio é obrigatória." })
